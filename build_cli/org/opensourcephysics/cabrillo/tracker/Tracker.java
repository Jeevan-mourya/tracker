...
// import javajs.async.SwingJSUtils.Performance; // removed because Performance is unavailable in workspace jars
...
//	    if (testOn) latestVersion = null; // for testing only
	...
	public static void main(String[] args) {
		...
		// javajs.async.SwingJSUtils.Performance is not available in the workspace jars.
